...
The Copilot CLI lets you use AI-powered commands in your terminal, such as `copilot suggest` and `copilot explain`.

**To install Copilot CLI via npm:**

```bash
npm install -g @githubnext/copilot-cli
```

For more information and usage examples, see the [Copilot CLI documentation](https://githubnext.com/projects/copilot-cli/).
